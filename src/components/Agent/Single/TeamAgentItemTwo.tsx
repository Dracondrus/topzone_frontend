    ...
    return (
        <div className="tp-team-inner-item d-flex mb-40">
            <div className="tp-team-inner-thumb mr-40">
                <Link href={`/agent-details/${item.id}`}><Image src={item.image} alt="agent image" /></Link>
            </div>
            <div className="tp-team-inner-content">
                <h4 className="tp-team-inner-content-title"><Link href={`/agent-details/${item.id}`}>{item.name}</Link></h4>
                ...
                <div className="tp-team-details-info-contact">
                    ...
                    <Link href={`mailto:${item.email}`}><span><TeamEmailSvg /></span>{item.email}</Link>
                </div>
